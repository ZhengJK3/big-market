...
import cn.chaZ.domain.strategy.service.IRaffleAward;
import cn.chaZ.domain.strategy.service.IRaffleStrategy;
import cn.chaZ.domain.strategy.service.armory.IStrategyArmory;
import cn.chaZ.trigger.api.IRaffleService;
import cn.chaZ.trigger.api.dto.RaffleAwardListRequestDTO;
import cn.chaZ.trigger.api.dto.RaffleAwardListResponseDTO;
import cn.chaZ.trigger.api.dto.RaffleRequestDTO;
import cn.chaZ.trigger.api.dto.RaffleResponseDTO;
import cn.chaZ.types.enums.ResponseCode;
import cn.chaZ.types.exception.AppException;
import cn.chaZ.types.model.Response;
...
public class RaffleController implements IRaffleService {
    ...
    public Response<List<RaffleAwardListResponseDTO>> queryRaffleAwardList(@RequestBody RaffleAwardListRequestDTO requestDTO) {
        try{
            log.info("查询奖品列表 strategyId:{}", requestDTO.getStrategyId());
            ...
            Response<List<RaffleAwardListResponseDTO>> response = Response.<List<RaffleAwardListResponseDTO>>builder()
                    ...
                    .build();
            log.info("查询奖品列表成功 strategyId:{}， response：{}", requestDTO.getStrategyId(), JSON.toJSONString(response));
            return response;
        } catch (Exception e){
